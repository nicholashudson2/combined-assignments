...
public class WageSlave implements Capitalist {
	...
	/**
     * @param name a string value representing the name of the element to be constructed
     * @param salary an int value representing the salary of the constructed element 
     */
    public WageSlave(String name, int salary) {
        this(name, salary, null); // Constructs an element using the next constructor, passing a null value for salary.
    }

    /**
     * @param name a string value representing the name of the element to be constructed
     * @param salary an int value representing the salary of the constructed element 
     * @param owner the FatCat element that is the constructed elements direct parent
     */
    public WageSlave(String name, int salary, FatCat owner) {
    	this.name = name; // Sets the constructed elements name to the given name
        this.salary = salary; // Sets the constructed elements salary to the given salary
       	this.owner = owner; // Sets the constructed elements parent to the given owner
    }
